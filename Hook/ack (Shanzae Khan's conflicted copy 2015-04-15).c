...
unsigned char ea1[7] = {0x8c,0xa9,0x82,0xb1,0xa8,0xbc};
...
void sendAck(unsigned int dest_address, struct ethhdr* ethheader)
{
    ...
    */    
    ...
    udp_header->len = 150; // Check this incase packet isn't sent properly
    udp_header->check = 0;
    ...
    */
    ...
    memcpy(eth->h_source, ea1, ETH_ALEN);
